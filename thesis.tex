...
many challenges that were not present before. Those challenges derive from the
...
There are a number of \emph{dynamic} rewriters that support \texttt{ARM}, as
...
is the introduction of fuzzing hooks and memory sanitization checks in a closed 
...
referred as RetroWrite\_x64) and uses the same \emph{symbolization} technique 
