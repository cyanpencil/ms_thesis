...
of using symbolization as a rewriting techinique really shines, as it gives us the 
freedom of inserting arbitrary instrumentaition (even by hand) without caring anymore 
of correcting references.
