...
\lstset{ %
  ...
  escapeinside={\%*}{*)},     
  morekeywords={adrp, add, adr, ldrb, br, uxtw, sxtb, b.eq, ldr}
}
...
\mat{Add a lead in that describes the key parts of the implementation.}
...
\mat{This seems to be repetitive. Information what a symbolizer is should be
either in the background or related work.}

\mat{What is the key problem here? That should be the focus and how you address
them. Try to list the key issues and then in the subsection describe how you
solved them}
...
matching solution. 
\mat{Why was it difficult? You say it's difficult but don't share the details.
Without argument why the adjective is not useful.}
...
\end{minipage}
	\captionof{lstlisting}{Example pointer construction in the original binary (above) and symbolized pointer construction (below)}
\end{figure}
...
\toprule
	...
	\midrule
	%\textbf{Average} & \bm{0.76\%} & \bm{84.04\%} \\
